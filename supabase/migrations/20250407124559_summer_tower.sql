/*
  # Add Admin Subscription for John

  1. Changes
    - Adds an active subscription for admin user (johnmcdermott1979@gmail.com)
...
-- First, get the user_id for johnmcdermott1979@gmail.com
DO $$
DECLARE
  v_user_id text;
BEGIN
  ...
  FROM users
  WHERE email = 'johnmcdermott1979@gmail.com';
